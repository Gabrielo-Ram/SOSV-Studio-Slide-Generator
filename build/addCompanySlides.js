...
const defaultHeroImage = "https://img.freepik.com/free-vector/abstract-pattern-design_1053-534.jpg";
/**
 ...
 */
export function companyCoverSlide(presentation, companyName, tagline, logoURL = defaultLogo, heroImageURL = defaultHeroImage) {
 ...
 * @param {string} heroImageURL An URL of the company's hero image
 * @param {string} logoURL An URL of the company's logo
 */
export function addOverviewSlide(presentation, verticals, country, description, heroImageURL = defaultHeroImage, logoURL = defaultLogo) {
    let slide = presentation.addSlide();
    slide.background = {
        path: heroImageURL,
        x: 0,
...
// export function finishingSlide() {
// }
